...
import com.y2080ad.yellowdog.services.accounts.AccountsServer;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (serverName.equals("accountsServer") || serverName.equals("accounts")) {
	...
	protected static void usage() {
		...
		System.out.println(
				"     where server-name is 'accounts', 'accountsServer', " + "'accounts' or 'web' and server-port > 1024");
	}
}
